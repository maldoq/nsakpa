    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('buyer', 'Acheteur'), ('artisan', 'Artisan'), ('admin', 'Administrateur')], default='buyer', max_length=10)),
                ('phone', models.CharField(max_length=20, unique=True)),
                ('profile_image', models.ImageField(blank=True, null=True, upload_to='profiles/')),
                ('location', models.CharField(blank=True, max_length=255, null=True)),
                ('bio', models.TextField(blank=True, null=True)),
                ('stand_name', models.CharField(blank=True, max_length=100, null=True)),
                ('stand_location', models.CharField(blank=True, max_length=255, null=True)),
